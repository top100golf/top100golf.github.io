...
Unlike country club memberships, golf courses don't always get to keep their spots in the Top 100 for life. The following `r ex_top_100_df %>% count()` courses used to be ranked in one of the two Top 100 lists but have dropped off. They have been sorted by the best rank achieved by that course, with ties broken by the number of times they appeared on a list.  
